<%-- 
    Document   : header
    Created on : Sep 10, 2024, 10:18:02 PM
    Author     : MSI
--%>
...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fa fa-chart-bar me-2"></i>Orders Items</a>
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="IndexOrderItemServlet" class="dropdown-item">All</a>
                </div>
            </div>
        </div>
    </nav>
